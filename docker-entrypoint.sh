...
echo "$TARSNAPPER_CRON root tarsnapper --target $TARNSNAPPER_OUTPUT_DIR/$TARSNAPPER_BACKUP_NAME --sources $TARSNAPPER_SOURCES --deltas $TARSNAPPER_DELTAS >> /tarsnapper.log 2>&1" > /tarsnapper-cron
